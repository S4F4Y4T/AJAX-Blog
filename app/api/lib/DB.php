<?php
	include_once $_SERVER['DOCUMENT_ROOT']."/rest/app/api/config/config.php";
	include_once $_SERVER['DOCUMENT_ROOT']."/rest/app/api/config/phpmailer/PHPMailerAutoload.php";
class DB{
